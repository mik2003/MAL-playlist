...
export function pauseSong() {
    ...
    (_a = playerState.player) === null || _a === void 0 ? void 0 : _a.pause();
    playerState.isPlaying = false;
    updatePlayPauseButtons();
...
export async function initializePlayer() {
    ...
    (_a = document.getElementById('playlist-search-input')) === null || _a === void 0 ? void 0 : _a.addEventListener('input', filterPlaylist);
    (_b = document.getElementById('playlist-search-filter')) === null || _b === void 0 ? void 0 : _b.addEventListener('change', filterPlaylist);
    document.addEventListener('keydown', (e) => {
        ...
        if (e.key === '/' && !e.ctrlKey && !e.metaKey && !e.altKey) {
            ...
            if (active instanceof HTMLElement) {
                ...
                if (!isTyping) {
                    e.preventDefault();
                    (_a = document.getElementById('playlist-search-input')) === null || _a === void 0 ? void 0 : _a.focus();
                }
            }
        }
    });
    ...
    (_c = document.getElementById('playlist-search-input')) === null || _c === void 0 ? void 0 : _c.addEventListener('focus', (e) => {
    ...
    playerState.player = new MediaElementPlayer('mediaelement-player', {
        ...
        success: function (media, // the <video> or <audio> element
        node, // the wrapper element
        instance // the MediaElementPlayer instance
        ) {
